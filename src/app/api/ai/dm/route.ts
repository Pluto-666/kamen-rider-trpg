...
**【假面舞会】是本TRPG的基础扩展，所有游戏内容必须以【假面舞会】的规则为基础依据。**
...
### 扩展规则：各骑士系列专属规则
**扩展规则是在【假面舞会】基础上的补充和扩展，不得与基础规则冲突。**

扩展规则示例：
- 龙骑系：镜世界规则、契约兽系统
- Blade系：觉醒卡系统、Undead规则
- Kabuto系：Clock Up机制、Zecter系统
- OOO系：硬币系统、Greeed规则
- Wizard系：魔法系统、Phantom规则
- Build系：满装瓶系统、Smash规则
- 等等...

### 规则适用原则
1. **基础规则优先**：当基础规则与扩展规则有冲突时，以【假面舞会】基础规则为准
2. **扩展规则补充**：扩展规则用于提供特定骑士系列的特色内容，在基础规则框架内使用
3. **无规则时参考基础**：如果扩展规则中没有涉及某个情况，回归【假面舞会】基础规则处理
